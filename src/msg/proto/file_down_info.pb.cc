...
static ::_pb::Metadata file_level_metadata_file_5fdown_5finfo_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_file_5fdown_5finfo_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_file_5fdown_5finfo_2eproto = nullptr;

const uint32_t TableStruct_file_5fdown_5finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_file_5fdown_5finfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024file_down_info.proto\022\tmsg.proto\"S\n\014fil"
  "eDownInfo\022\014\n\004name\030\001 \002(\t\022\014\n\004size\030\002 \002(\004\022\014\n"
  "\004hash\030\003 \002(\t\022\031\n\021humanReadableSize\030\004 \002(\t\"="
  "\n\017FileDownInfoMsg\022*\n\tfileinfos\030\001 \003(\0132\027.m"
  "sg.proto.fileDownInfoB\002H\002"
  ;
static ::_pbi::once_flag descriptor_table_file_5fdown_5finfo_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_file_5fdown_5finfo_2eproto = {
    false, false, 185, descriptor_table_protodef_file_5fdown_5finfo_2eproto,
    "file_down_info.proto",
    &descriptor_table_file_5fdown_5finfo_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_file_5fdown_5finfo_2eproto::offsets,
    file_level_metadata_file_5fdown_5finfo_2eproto, file_level_enum_descriptors_file_5fdown_5finfo_2eproto,
    file_level_service_descriptors_file_5fdown_5finfo_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_file_5fdown_5finfo_2eproto_getter() {
  return &descriptor_table_file_5fdown_5finfo_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_file_5fdown_5finfo_2eproto(&descriptor_table_file_5fdown_5finfo_2eproto);
namespace msg {
namespace proto {
...
::PROTOBUF_NAMESPACE_ID::Metadata fileDownInfo::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_file_5fdown_5finfo_2eproto_getter, &descriptor_table_file_5fdown_5finfo_2eproto_once,
      file_level_metadata_file_5fdown_5finfo_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata FileDownInfoMsg::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_file_5fdown_5finfo_2eproto_getter, &descriptor_table_file_5fdown_5finfo_2eproto_once,
      file_level_metadata_file_5fdown_5finfo_2eproto[1]);
}
